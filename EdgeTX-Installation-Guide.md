...
1. Download the current EdgeTX firmware. You can download the latest release .zip file (edgetx-firmware-v2.6.0.zip) directly from Github -https://github.com/EdgeTX/edgetx/releases/tag/v2.6.0
