...
1. Download the current EdgeTX Firmware. You can download the release candidate build .zip file (edgetx-firmware-v2.4.0.zip) directly from Github -https://github.com/EdgeTX/edgetx/releases/tag/v2.4.0
