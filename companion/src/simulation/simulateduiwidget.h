...
class SimulatedUIWidgetPL18EV: public SimulatedUIWidget
{
  Q_OBJECT

  public:
    explicit SimulatedUIWidgetPL18EV(SimulatorInterface * simulator, QWidget * parent = nullptr);
    virtual ~SimulatedUIWidgetPL18EV();

  private:
    Ui::SimulatedUIWidgetPL18EV * ui;
};
