...
#include "ui_simulateduiwidgetPL18EV.h"

SimulatedUIWidgetPL18EV::SimulatedUIWidgetPL18EV(SimulatorInterface *simulator, QWidget * parent):
  SimulatedUIWidget(simulator, parent),
  ui(new Ui::SimulatedUIWidgetPL18EV)
{
  RadioUiAction * act;
  ...
  //  Note: the PL18EV has no physical buttons though at some point the trim joystick is repurposed
...
SimulatedUIWidgetPL18EV::~SimulatedUIWidgetPL18EV()
{
  delete ui;
}
